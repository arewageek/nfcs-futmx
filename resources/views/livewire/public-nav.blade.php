<div class="w-full py-5 px-5 shadow-xl navbar fixed top-0 left-0 backdrop-blur-md bg-[#fff5] z-[999999999999]">
    <div class="flex md:hidden justify-between items-center text-sm font-bold">
        ...
        <div>
            <div class="p-2 bg-gray-700 shadow rounded-md hover:bg-gray-600 hover:shadow-lg">
    ...
    <div class="hidden md:block">
        ...
        {{-- <div class="flex justify-around text-sm mb-5 items-center border-b-2 border-b-gray-600 py-4 sticky">
            ...
            <div class="flex justify-around items-center space-x-3">
                <div class="cursor-pointer bg-gray-700 hover:text-gray-950 hover:bg-blue-500 p-2 rounded-full transition">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-instagram h-[8pt] w-[8pt] md:h-[16px] md:w-[16px]" viewBox="0 0 16 16">
                ...
                <div class="cursor-pointer bg-gray-700 hover:text-gray-950 hover:bg-blue-500 p-2 rounded-full transition">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-facebook h-[8pt] w-[8pt] md:h-[16px] md:w-[16px]" viewBox="0 0 16 16">
                        <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                    </svg>
                </div>

                <div class="cursor-pointer bg-gray-700 hover:text-gray-950 hover:bg-blue-500 p-2 rounded-full transition">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-whatsapp h-[8pt] w-[8pt] md:h-[16px] md:w-[16px]" viewBox="0 0 16 16">
